...
void getAllDependentsByAgeAndContactName(Contact contacts[], int dependentAge, char contactName[]) {
}
...
Node* createContact(const char* id, const char* name, const char* lastName, int age, const char* taxNumber, const char* neighborhood, const char* email, const char* phone) {
...
void createMockContacts(Node** head) {
    insertContact(head, createContact("3", "Alice", "Johnson", 42, "45678912300", "Midtown", "alice.johnson@example.com", "71982659845"));
    insertContact(head, createContact("1", "John", "Doe", 35, "12345678901", "Downtown", "john.doe@example.com", "71982659845"));
    insertContact(head, createContact("2", "Jane", "Smith", 28, "98765432100", "Uptown", "jane.smith@example.com", "71982659845"));
}

void createMockContactWithDependent(Node** head) {
    Node* contact = createContact("4", "Bob", "Builder", 50, "32165498700", "Hometown", "bob.builder@example.com", "71982659845");
